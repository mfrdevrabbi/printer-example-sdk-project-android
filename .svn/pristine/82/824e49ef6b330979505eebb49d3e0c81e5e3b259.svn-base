...
public class ImagePrintActivity extends BaseActivity implements View.OnClickListener {
    ...
    private final static String TAG = "ImagePrintRongta";
    ...
    private void tscPrint() throws SdkException {
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                commonSetting.setLableSizeBean(new LableSizeBean(bmpPrintWidth, (mBitmap.getHeight()+7)/8));
    ...
    private void zplPrint() throws SdkException {
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                CommonSetting commonSetting = new CommonSetting();
                commonSetting.setLableSizeBean(new LableSizeBean(bmpPrintWidth, 150));
                commonSetting.setLabelGap(3);
...
//        cmd.append(toPrintBytes);
                ...
                Log.i(TAG, FuncUtils.ByteArrToHex(cmd.getAppendCmds()));
...
//                if(bmpPrintWidth==1)
//                    mode=BmpPrintMode.MODE_SINGLE_COLOR;
//                if(bmpPrintWidth==2)
//                    mode=BmpPrintMode.MODE_MULTI_COLOR;
//                if(bmpPrintWidth==3)
//                    mode=BmpPrintMode.MODE_SINGLE_FAST;
